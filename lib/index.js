...
export default function generate(webIdlString) {
    ...
    var needsReflector = attributes.some(a => a.extAttrs.findIndex(xa => xa.name === "Reflect") !== -1);

    var moduleTree = codeGen.moduleTree(theInterface.name, { includeReflector: needsReflector });
