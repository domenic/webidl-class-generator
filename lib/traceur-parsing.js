...
const PlaceholderParser = require("traceur").get("codegeneration/PlaceholderParser.js");
const { CloneTreeTransformer: { cloneTree } } = require("traceur").get("codegeneration/CloneTreeTransformer.js");
