...
export function nonEnumerableMethodsTrees(className, methodNames) {
    return Array.from(methodNames).map(methodName =>
        parseStatement`Object.defineProperty(${id(className)}.prototype, ${methodName}, { enumerable: false });`
    );
}
